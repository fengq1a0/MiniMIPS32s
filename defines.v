...
/*------------------- �쳣�������� -------------------*/
`define EXC_CODE_BUS        4 : 0           // �쳣�����������ݿ���
`define EXC_INT             5'b00           // �ж��쳣�ı���
`define EXC_ADEL            5'h04           // ȡֵ��������쳣�ı���
`define EXC_ADES            5'h05           // д�����쳣�ı���
`define EXC_SYS             5'h08           // ϵͳ�����쳣�ı���
`define EXC_BP              5'h09           // ִ�жϵ�ָ��
`define EXC_RI              5'h0a           // ����ָ������              
`define EXC_OV              5'h0c           // ��������쳣�ı���
`define EXC_NONE            5'h10           // ���쳣
`define EXC_ERET            5'h11           // ERET�쳣�ı���
`define EXC_ADDR            32'hbfc00380    // �쳣����������ڵ�ַ
`define EXC_INT_ADDR        32'hbfc00380    // �ж��쳣����������ڵ�ַ
